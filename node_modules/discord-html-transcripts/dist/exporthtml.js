...
function generateTranscript(messages, channel, opts) {
    ...
    var _loop_1 = function (message) {
        ...
        var mm = message.createdAt.getMonth() + 1;
        var dd = message.createdAt.getUTCDate();
        timestamp.textContent = "".concat(dd, "/").concat(mm, "/").concat(yyyy);
        timestamp.title = he.escape(message.createdAt.toLocaleTimeString("en-us", exports.date.options));
