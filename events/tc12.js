...
if(!interaction.isButton() && !interaction.isSelectMenu()) return;
      ...
      if(interaction.customId == `create_ticket${s}`) {
        ...
        .setAuthor(`Ticket for: ${interaction.user.tag}`, interaction.user.displayAvatarURL(), `https://discord.gg/x6TZyyxaTq`)
  ...
  .setRequired(true)
    ...
    showModal(modal, {
      ...
      interaction: interaction 
        ...
        .setFooter({text: `𝐊 Δ 𝐑 𝐌 Δ`, iconURL: (`https://media.discordapp.net/attachments/987778608401621002/1018206529289195660/20220910_213653.gif`)})
